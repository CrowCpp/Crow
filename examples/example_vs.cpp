...
struct ExampleMiddleware {
  ...
  void setMessage(const std::string& newMsg) { message = newMsg; }
...
int main() {
  ...
  app.route_dynamic("/path/")([]() { return "Trailing slash test case.."; });
  ...
  app.route_dynamic("/add/<int>/<int>")([](crow::response& res, int a, int b) {
    std::ostringstream os;
    os << a + b;
    res.write(os.str());
    res.end();
